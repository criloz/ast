import {between, character, choice, digits, greedyAvoid, greedyChoice, many1, Parser, sequenceOf, str} from "./parser";
...
export const custom_str_sep = parser => new Parser(parserState => {
...
export class LiteralInt {
    constructor(value) {
        this.kind = '#integer literal';
        this.value = value;
    }
}

export const literal_natural_number = digits.map((r) => new LiteralInt(r));
